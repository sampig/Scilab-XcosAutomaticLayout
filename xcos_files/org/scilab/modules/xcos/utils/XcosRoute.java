...
public class XcosRoute {
    ...
    /**
     * Check whether the two points are aligned or not (Considering the
     * acceptable error - <code>XcosRoute.ALIGN_ERROR</code>).
     * 
     * @param point1
     *            the first point
     * @param point2
    ...
    /**
     * Check whether the two points are strictly aligned or not. (The accepted
     * error is <code>XcosRoute.ALIGN_STRICT_ERROR</code>)
     * 
     * @param x1
     *            the x-coordinate of the first point
     * @param y1
     ...
     */
    public static boolean isStrictAlighed(double x1, double y1, double x2, double y2) {
