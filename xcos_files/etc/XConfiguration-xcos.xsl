...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="xcos-edition">
        <Grid>
            ...
            <Label gridx="1" gridy="4" text="_(Graph block distance)"/>
            <NumericalSpinner gridx="2" gridy="4" value="{@graph-block-distance}" enable="true" increment="1" min-value="{@graph-grid}" listener="ActionListener">
                <actionPerformed choose="graph-block-distance">
                    <xsl:call-template name="context"/>
                </actionPerformed>
            </NumericalSpinner>
        </Grid>
